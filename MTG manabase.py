...
for _ in range(num_iterations):
    ...
    countW  += (c_color_keep and land_keep)
    countU  += (d_color_keep and land_keep)
    countB  += (e_color_keep and land_keep)
    countWU += (c_color_keep and d_color_keep and land_keep)
    countUB += (d_color_keep and e_color_keep and land_keep)
    countWB += (c_color_keep and e_color_keep and land_keep)
    countWUB += (c_color_keep and d_color_keep and e_color_keep and land_keep)
    #全体除去を引いているか
    m_keep = m_need <= (draw['M'])
    countm += (c_color_keep and land_keep and m_keep)
    #侮辱を打てるかどうか
    v_keep = v_need <= (draw['V'])
    countv += (e_color_keep and land_keep and v_keep)
    #侮辱または全体除去
    countvm += (e_color_keep and land_keep and v_keep)
    countvm += (c_color_keep and land_keep and m_keep)
...
#参考文献　　https://article.hareruyamtg.com/article/article_5462/
